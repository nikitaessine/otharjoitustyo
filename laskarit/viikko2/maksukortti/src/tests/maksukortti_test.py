...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_edullisesti_vahentaa_saldoa_jos_vain_mimimaara_rahaa(self):
        self.kortti = Maksukortti(2.5)
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0.0 euroa")
    
    def test_syo_maukkaasti_vahentaa_saldoa_jos_vain_mimimaara_rahaa(self):
    ...
    def test_ei_voi_ladata_negatiivista_arvoa(self):
